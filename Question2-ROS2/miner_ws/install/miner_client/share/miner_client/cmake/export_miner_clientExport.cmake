...
foreach(_expectedTarget miner_client::miner_client)
...
# Create imported target miner_client::miner_client
add_library(miner_client::miner_client SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/export_miner_clientExport-*.cmake")
